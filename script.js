...
const votes = [
  {name:'Jacob Leake',votes:124},{name:'Cage Keysor',votes:73},{name:'Clayton Adkins',votes:39},
  {name:'Chris Poor',votes:33},{name:'Krazy Kat Ladies',votes:23},{name:'Skip Martin',votes:16},
  {name:'Clint Bafford',votes:10},{name:'Matt Stewart',votes:10},{name:'Corey Jeffers',votes:10},
  {name:'Jon Myers',votes:9},{name:'Cameron Marriott',votes:9},{name:'Blayne Peterman',votes:8},
  {name:'Dan Phelps',votes:7},{name:'Jeff Tate',votes:5},{name:'Justin Johnston',votes:4},
  {name:'Troy Geer',votes:4},{name:'Brier Thompson',votes:2},{name:'John Drummond',votes:2},
  {name:'Brandon Hunter',votes:2},{name:'Jason Berenato',votes:1},{name:'Austin Harding',votes:1},
  {name:'John Ratliff',votes:1},{name:'Shawn Wiseman',votes:1},{name:'David Rose',votes:1}
];
const votesLastUpdated = 'July 20, 2026 at 2:59 PM ET';
...
const refreshedVoteVoters = {
  'Jacob Leake':['Ashley Turben','Patrick Milner','Nathan Reiling','Gage Smith','Josh Peoples','Brenda Zirkle','Bill Taylor','Nathan Hagan','Tanner Emerson','Alyson Lafollette','Kristi Preston','Hayden Boggess','Tyler Culbertson','Jackie Bickley-glover','Cory Stewart','Bobbi Moore'],
  'Cage Keysor':['Lena Nguyen','Paije Forsthoefel','Cameron Patrick','Jared Osborne','Logan Brosher','Jj Mccanless','Gage Larsen','Amanda Bowman','Jon Redding','Debra Brewer','Connor Keiber','Shania Emans','Larry Blackburn','Austin Robinson','Keyton Liming','Brian Rivera','Dalton Fuson','Emily Baker'],
  'Clayton Adkins':['Emma Fisher','Sue Barker','Tammy Castle Gonzalez'],
  'Krazy Kat Ladies':['Ashleigh Campbell','Mike Taylor','Carla Hood-Taylor'],
  'Corey Jeffers':['Matthew Jeffers','Mark Rupe'],
  'Blayne Peterman':['Scott Michael','Deena Jacqueline'],
  'Troy Geer':['Nora Svatek','Shane Peleras'],
  'Chris Poor':['Missy Jessie'],
  'Clint Bafford':['Angie Beau Burns'],
  'Cameron Marriott':['Alissa Taylor'],
  'Dan Phelps':['Hunter Hatcher'],
  'Brandon Hunter':['Robert Andrews'],
  'Skip Martin':['Ron Brown'],
  'Matt Stewart':['Andi Stewart Cawley'],
  'David Rose':['Wade Rose']
};
Object.entries(refreshedVoteVoters).forEach(([angler,names])=>{voteVoters[angler]=[...(voteVoters[angler]||[]),...names]});
const products = [
  {id:'trail-tee',name:'Official Trail Tee',price:30,category:'apparel',badge:'New',image:'assets/merch/official-trail-tee.webp?v=2',description:'The official Katyakers of Ohio trail logo tee.',sizes:['S','M','L','XL','2XL','3XL'],sizeAdjustments:{'2XL':2,'3XL':4},checkout:{base:'https://buy.stripe.com/fZu14n5Kue4Y6NL7OG18c01','2XL':'https://buy.stripe.com/eVqeVd3Cmf922xv5Gy18c04','3XL':'https://buy.stripe.com/dRm14na0K1ic8VTd9018c05'}},
  {id:'schedule-tee',name:'2026 Schedule Tee',price:30,category:'apparel',badge:'New',image:'assets/merch/schedule-tee.webp?v=2',description:'The complete 2026 Katyakers tournament schedule in one bold design.',sizes:['S','M','L','XL','2XL','3XL'],sizeAdjustments:{'2XL':2,'3XL':4},checkout:{base:'https://buy.stripe.com/eVqaEXdcWf92dc98SK18c00','2XL':'https://buy.stripe.com/aFafZhb4O1ic5JHfh818c06','3XL':'https://buy.stripe.com/3cI28rb4Of92c85ed418c07'}},
