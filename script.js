...
const votes = [
  {name:'Jacob Leake',votes:124},{name:'Cage Keysor',votes:69},{name:'Clayton Adkins',votes:39},
...
const votesLastUpdated = 'July 17, 2026 at 3:02 PM ET';
...
const refreshedVoteVoters = {
  ...
  'Cage Keysor':['Lena Nguyen','Paije Forsthoefel','Cameron Patrick','Jared Osborne','Logan Brosher','Jj Mccanless','Gage Larsen','Amanda Bowman','Jon Redding','Debra Brewer','Connor Keiber','Shania Emans','Larry Blackburn','Austin Robinson'],
